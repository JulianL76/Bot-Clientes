...
def guardar_y_continuar():
    """
    Simula guardar pero en realidad SALIR sin guardar para fines de prueba y depuración.
    """
    print("\n--- [ SALIR Y CONTINUAR (DEBUG MODE) ] ---")
    BotState.is_saving = True # <-- Desactivar monitor de popups durante el guardado
    
    print("    - DEBUG Paso 1: Clic Salir (251, 59)")
    pyautogui.moveTo(251, 59, duration=0.5)
    pyautogui.click(x=251, y=59)
    time.sleep(0.5)
    
    print("    - DEBUG Paso 2: Clic Confirmar Salida (861, 514)")
    pyautogui.moveTo(861, 514, duration=0.5)
    pyautogui.click(x=861, y=514)
    time.sleep(0.5)
    
    print("    - DEBUG Paso 3: Clic Nuevo (282, 85)")
    pyautogui.moveTo(282, 85, duration=0.5)
    pyautogui.click(x=282, y=85)
    time.sleep(0.5)
    
    # Nuevo paso proporcionado
    print("    - DEBUG Paso 4: Clic Intermedio (509, 465)")
    pyautogui.moveTo(509, 465, duration=0.5)
    ...
    print("    - Pausa extra de 1 segundo antes de continuar con el siguiente...")
    time.sleep(1.0)
...
def main():
    ...
    print("[DEBUG] Limitando ejecución a las primeras 5 filas para evitar problemas en recursión.")
    df_debug = df.head(5)
